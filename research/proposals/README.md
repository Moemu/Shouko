...
- [ZCode：横漂机制分解与方向控制三层路线](2026-09-26/ZCode-横漂机制分解与方向控制三层路线.md) — 独立提案：横漂主体为身体系侧滑 trim（约97%）而非航向误差，精确朝向受步态锁相摆动限制；提出 Phase 0 机制定标、读出方向再拟合主臂、教师精化条件臂与相位盲 DAgger 并行臂，均未执行。
