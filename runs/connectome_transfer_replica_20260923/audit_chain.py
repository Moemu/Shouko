...
root=Path('runs/connectome_transfer_replica_20260923');prior=Path('runs/prior')
...
assert sha('runs/source/best.pt')=='458fc465a6fb802a338c218fc4be414fc9153376c5d2f76f116518e6cc5aa475'
